  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav" style="gap: 15px;">
        <li>
          <a href="memproses_permohonan.php" style="color: #222; font-family: 'Poppins', sans-serif; font-weight: 500; padding: 15px 15px; text-decoration: none;"
        ...
        <li>
          <a href="inventori_bantuan.php" style="color: #222; font-family: 'Poppins', sans-serif; font-weight: 500; padding: 15px 15px; text-decoration: none;"
             onmouseover="this.style.textDecoration='underline'" 
             onmouseout="this.style.textDecoration='none'">
            Inventori Bantuan
          </a>
        ...
        <li>
          <a href="daftar_penderma.php" style="color: #222; font-family: 'Poppins', sans-serif; font-weight: 500; padding: 15px 15px; text-decoration: none;"
             onmouseover="this.style.textDecoration='underline'" 
             onmouseout="this.style.textDecoration='none'">
            Daftar Penderma
          </a>
