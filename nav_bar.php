  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav" style="gap: 15px;">
        <li>
          <a href="borang_permohonan.php" style="color: #222; font-family: 'Poppins', sans-serif; font-weight: 500; padding: 15px 15px; text-decoration: none;"
        ...
        <li>
          <a href="status_permohonan.php" style="color: #222; font-family: 'Poppins', sans-serif; font-weight: 500; padding: 15px 15px; text-decoration: none;"
             onmouseover="this.style.textDecoration='underline'" 
             onmouseout="this.style.textDecoration='none'">
            Status Permohonan
          </a>
      ...
      <ul class="nav navbar-nav navbar-right" style="display: flex; align-items: center; gap: 15px;">
        ...
        <?php else: ?>
          <li><a href="login_pelajar.php" style="color: #222; font-family: 'Poppins', sans-serif; font-weight: bold; padding: 10px 15px;">Log Masuk</a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
